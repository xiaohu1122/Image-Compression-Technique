...
class QTree {
 ...
 private:
  ...
  priority_queue<Node*, std::vector<Node*>, node_cmp> q; // collection of leaves
  ...
  void render(Node* root, PNG & img,bool drawFrame, RGBAPixel frameColor);
  void clear(Node* root);
  Node* copy(const Node* root, PNG im);
//  RGBAPixel avgC(Node* n, PNG im);
